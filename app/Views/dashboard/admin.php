...
<body class="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl shadow-2xl p-6 mb-6 border border-purple-500/20">
            ...
            <p class="text-purple-300">Your personalized dashboard</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-xl font-bold text-white">Total Users</h3>
                    <i class="fas fa-users text-blue-200 text-3xl"></i>
                </div>
                <p class="text-5xl font-bold text-white"><?= $totalUsers ?></p>
                <p class="text-blue-200 mt-2">Registered in the system</p>
            </div>

            <!-- Recently Registered Users -->
            <div class="lg:col-span-2 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-xl p-6 border border-purple-500/20">
                <h3 class="text-xl font-bold text-white mb-4">Recently Registered Users</h3>
